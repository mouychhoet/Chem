...
document.querySelectorAll('.car-button').forEach(button => {
    button.addEventListener('click', function() {
        ...
        alert(`Thank you for your interest in the ${carName}! Our team will contact you soon.`);
    });
});
...
document.querySelectorAll('.car-card, .feature-card, .stat').forEach(el => {
    el.style.opacity = '0';
...
// Add hover effects for car cards
...
console.log('AutoWorld website loaded successfully! 🚗'); 